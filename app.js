...
const RULE_EXPLANATIONS = {
    ...
    'Adjacency': {
        ...
        desc: 'Two terms that differ in exactly one literal (one normal, one complemented) combine to drop that literal entirely — the Boolean equivalent of merging K-map cells.',
    ...
    'Consensus Theorem (Term Added)': {
        ...
        desc: 'The reverse of elimination: strategically introduce the consensus term BC (which is logically redundant) to enable further simplifications — such as an Absorption or Adjacency step that follows.',
    ...
    'Identity': {
        title: 'Identity Law',
        formula: 'A + 0 = A  |  A · 1 = A',
        desc: 'OR-ing with 0 or AND-ing with 1 leaves a variable unchanged — 0 is the identity for OR, 1 is the identity for AND.',
    ...
    'Idempotence': {
        ...
        formula: 'A + A = A  |  A · A = A',
        desc: 'Repeating the same term in OR or AND changes nothing — the duplicate is safely removed.',
    ...
    'Associativity': {
        ...
        desc: 'Regrouping terms in an AND or OR chain does not change the outcome — brackets can be freely moved.',
    ...
    'Implication (Self)': {
        ...
        formula: 'A → A = 1',
        desc: 'A proposition trivially implies itself — the result is always true.',
    ...
    'Negation (XOR)': {
        title: 'XOR Negation',
        formula: '(A ⊕ B)\' = A ↔ B',
        desc: 'The negation of XOR is XNOR — flipping the output of XOR is equivalent to checking equality.',
    ...
    'Negation (XNOR)': {
        title: 'XNOR Negation',
        formula: '(A ↔ B)\' = A ⊕ B',
        desc: 'The negation of XNOR is XOR — flipping the equality check gives inequality.',
    ...
    'Normalization (Expand XOR)': {
        ...
        formula: 'A ⊕ B = AB\' + A\'B',
        desc: 'Expands Exclusive-OR into its fundamental AND/OR/NOT (SOP) form, enabling standard boolean simplification rules to apply.',
    ...
    'Normalization (Expand XNOR)': {
        ...
        formula: 'A ↔ B = AB + A\'B\'',
        desc: 'Expands Exclusive-NOR into its fundamental AND/OR/NOT (SOP) form — the inverse of XOR expansion.',
